...
class MyRidesHistoryPage extends ConsumerStatefulWidget {
  const MyRidesHistoryPage({super.key});
            ...
            if (booking.transporter != null)
              Row(
                children: [
                  CircleAvatar(
                    radius: 24,
                    backgroundImage: booking.transporter!.profileImage.isNotEmpty
                        ? NetworkImage(booking.transporter!.profileImage)
                        : AssetImage("assets/images/driverflutter.png") as ImageProvider,
                  ),
                  SizedBox(width: 12),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
